...
export default {
  ...
  contact: {
    ...
    options: {
      ...
      creatorsUgc: 'Creator Branding / UGC',
  ...
  creators: {
    ...
    title: 'Turn Creators',
    titleHighlight: 'Into Brands',
    description: 'UGC content generation, social media growth on TikTok & Instagram, audiovisual production studios worldwide, and business model optimization for creators.',
    ...
    services: {
      ...
      description: 'Everything you need to build, grow, and monetize your personal brand.',
      ugc: {
        title: 'UGC Content Generation',
        subtitle: 'Authentic Brand Content',
        description: 'We create high-converting user-generated content for brands and creators. From strategy to production, we deliver content that feels organic and drives engagement.',
      },
      brand: {
        title: 'Creator to Brand',
        subtitle: 'Personal Brand Architecture',
        description: 'We transform artists and content creators into recognizable brands. From visual identity and positioning to audience strategy and monetization frameworks.',
      },
      social: {
        title: 'Social Media Growth',
        subtitle: 'TikTok, Instagram & YouTube',
        description: 'Data-driven social media marketing that grows your audience and engagement. We optimize profiles, develop content calendars, and execute growth strategies.',
      },
    },
    studios: {
      badge: 'Global Production',
      title: 'Production Studios',
      description: 'Professional audiovisual production across three continents.',
      dubai: 'Full-service production studio in Dubai Media City. 4K/8K video, podcast studios, and green screen facilities.',
      china: 'Content production hub in Shenzhen. Specialized in product videography, unboxing content, and e-commerce media.',
      usa: 'Creative studio in Miami focused on lifestyle, music, and entertainment content. Bilingual (EN/ES) production team.',
    },
    business: {
      title: 'Business Model Optimization',
      description: 'We don\'t just create content — we build sustainable businesses around your personal brand.',
      revenue: 'Revenue Streams',
      revenueDesc: 'Diversify income with brand deals, merch, courses, subscriptions, and affiliate programs.',
      analytics: 'Analytics & Growth',
      analyticsDesc: 'Data-driven decisions with audience insights, content performance metrics, and growth forecasting.',
      partnerships: 'Brand Partnerships',
      partnershipsDesc: 'We connect creators with brands that align with their audience for authentic collaborations.',
      legal: 'Legal & Structure',
      legalDesc: 'Company setup, contract management, IP protection, and tax optimization for creator businesses.',
    },
    process: {
      title: 'Our Process',
      audit: 'Audit',
      auditDesc: 'Analyze your current brand & content',
      strategy: 'Strategy',
      strategyDesc: 'Build your growth & monetization plan',
      production: 'Production',
      productionDesc: 'Create content at our global studios',
      distribution: 'Distribution',
      distributionDesc: 'Publish & amplify across platforms',
      scale: 'Scale',
      scaleDesc: 'Optimize, monetize & grow revenue',
    },
    contact: {
      title: 'Build Your Brand',
      description: 'Tell us about your content and goals — we\'ll design your growth strategy.',
    },
  },
